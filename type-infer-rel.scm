...
;;[ja] ============================================================
;;[ja] 型付け関係の本体。(!-o Γ e T) = 「環境 Γ で式 e は型 T」。
;;[ja] conde の各節が構文 1 つに対応。前向き(e 固定)にも後ろ向き
;;[ja] (T 固定で e を列挙 = inhabitants)にも走る。配列マクロは
;;[ja] 展開せずこの形のまま型付け(vec-operando など)。数値は
;;[ja] numeric-mode に従い、既定 unified では幅を決めない(num 一種)。
;;[ja] ============================================================
