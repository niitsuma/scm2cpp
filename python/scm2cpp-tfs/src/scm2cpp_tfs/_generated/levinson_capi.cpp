...
//   g++ -O2 -std=c++17 -shared -fPIC -I. -o liblevinson.so levinson_capi.cpp
#include "levinson.hpp"
#include <vector>
#include <algorithm>

extern "C" int scm2cpp_levinson(double* r, double* phi, double* work, double* pacf, double* errs, int p) {
  return levinson(r, phi, work, pacf, errs, p);
}
